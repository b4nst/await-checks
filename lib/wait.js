...
function wait(ghToken, namePattern, includeQueued, waitMs) {
  return __awaiter(this, void 0, void 0, function*() {
    ...
    while (true) {
      ...
      const awaiting = yield exports.getRunningChecksCount(
        octokit,
        namePattern,
...
exports.wait = wait
exports.getRunningChecksCount = (octo, namePattern, status) =>
  __awaiter(this, void 0, void 0, function*() {
    const checks = yield octo.checks.listForRef(
      Object.assign({}, context.repo, { ref: context.ref })
    )
    console.log('Checks found:', checks)
    if (!checks.data) return 0
    return exports.countMatchingChecks(
      checks.data.check_suites,
      namePattern,
      status
    )
  })
exports.countMatchingChecks = (checks, pattern, status) =>
  _.filter(
    checks,
    c =>
